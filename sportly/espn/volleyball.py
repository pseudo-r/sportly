"""sportly.espn.volleyball — NCAA men's and women's volleyball."""
...
SPORT = "volleyball"
DEFAULT_LEAGUE = "womens-college-volleyball"
...
def standings(league: str = DEFAULT_LEAGUE, *, client: SportlyClient | None = None) -> Standings:
    return _standings_ep.standings(SPORT, league, client=client)
